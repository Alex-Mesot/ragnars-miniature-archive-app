...
Create:
- `00_Apps/archive_update_config.json`
...
- Build/release scripts under `01_Build/`.
- Build outputs in `01_Build/dist/` and build cache in `01_Build/build/`.
- Local helper/state files in `01_Build/.state/` (generated by `01_Build/publish_release.sh`).
